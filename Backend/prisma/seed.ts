...
const properties = [
  ...
  },
  {
    ...
    description: "Budget co-living space just 220m from Doon Business School (DBS). Includes dedicated silent study room, high-speed fiber, healthy home food, and laundry.",
    city: "Dehradun",
    neighborhood: "Selaqui",
    locality: "Selaqui",
    state: "Uttarakhand",
    country: "India",
    address: "Pharma City Road, Near DBS Campus, Selaqui, Dehradun",
  ...
  },
  {
    ...
    description: "Budget-friendly and spacious student hostel just 200m from Tula's Institute campus gate. Regular transport, warm food, sports lawn, and power backup.",
    city: "Dehradun",
    neighborhood: "Dhoolkot",
    locality: "Selaqui",
    state: "Uttarakhand",
    country: "India",
    address: "Dhoolkot Road, Near Tula's Gate, Selaqui, Dehradun",
    formattedAddress: "Dhoolkot, Selaqui, Dehradun, Uttarakhand 248011, India",
    latitude: 30.3620,
    longitude: 77.8755,
    category: PropertyCategory.PG,
    price: 7000,
